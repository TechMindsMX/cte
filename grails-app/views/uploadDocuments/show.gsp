            ...
            <div class="portlet-body">
              <div class="col-sm-4 col-md-4">
                <ul >
                  ...
                  <li>
                    <p>
                      <a href="${document.localUrl}" class="btn btn-default" download><i class="fa fa-download"></i></a>
                      <a href="#" class="documentIframe" path="${document.localUrl}" ><g:message code="document.type.${document.type}" /> </a>
                    </p>
                  </li>
                  </g:each>
                  <p><hr></p>
