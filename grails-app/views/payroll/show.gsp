...
<html>
    ...
    <body>
        ...
        <div id="show-payroll" class="content scaffold-show" role="main">
            ...
            <f:display bean="payroll" />
            <g:form resource="${this.payroll}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.payroll}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
